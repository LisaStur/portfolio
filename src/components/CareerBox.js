...
import { ColumnContainer, BigText, StyledLink, RowSpaceBetween } from '../Style'
...
export const CareerBox = () => {
  ...
  return (
    <ColumnContainer>
      ...
      <BigText>
        LinkedIn: &nbsp;
        <StyledLink href='https://www.linkedin.com/in/lisa-stureg%C3%A5rd-2624241'>Lisa's LinkedIn</StyledLink>
      </BigText>
      <BigText>
        GitHub: &nbsp;
